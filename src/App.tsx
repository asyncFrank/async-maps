...
import { MapContainer as MapContainerLeaflet, Marker, Popup, TileLayer } from "react-leaflet";
...
function App() {
  ...
  // const loadOptions = async (inputValue: string, callback: (places: any[]) => void) => {
  //     if (inputValue.length < 5) return;
  //     // let places: any = [];
  //     const response = await fetchLocalMapBox(inputValue);
